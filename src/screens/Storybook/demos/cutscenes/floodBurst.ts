...
export function floodBurst(root: Container, w: number, h: number): () => void {
  ...
  later(() => { animate(tunnelG, { alpha: 1, duration: 1000 }); animate(gateG, { alpha: 1, duration: 900 }); }, 400);
