...
import wgslVertex from './default.wgsl?raw';
import fragment from './reflection.frag?raw';
import source from './reflection.wgsl?raw';
...
export interface ReflectionFilterOptions2 {
  /**
 ...
 * @extends Filter
 */
export class ReflectionFilter2 extends Filter {
  /** Default values for options. */
  public static readonly DEFAULT_OPTIONS: ReflectionFilterOptions2 = {
    mirror: true,
    boundary: 0.5,
    amplitude: [0, 20],
    waveLength: [30, 100],
   ...
   */
  constructor(options?: ReflectionFilterOptions2) {
    options = { ...ReflectionFilter2.DEFAULT_OPTIONS, ...options };
   ...
   */
  get amplitude(): Range {
    return Array.from(this.uniforms.uAmplitude) as Range;
  }
  ...
  get waveLength(): Range {
    return Array.from(this.uniforms.uWavelength) as Range;
  }
   ...
   */
  get alpha(): Range {
    return Array.from(this.uniforms.uAlpha) as Range;
  }
