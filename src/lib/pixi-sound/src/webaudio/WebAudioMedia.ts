...
import { type LoadedCallback, Sound } from '../Sound';
...
class WebAudioMedia implements IMedia {
   ...
   * @readonly
   */
  public parent: Sound = null!;

  /**
   * The file buffer to load.
   * @readonly
   */
  public source: ArrayBuffer | AudioBuffer = null!;

  /** Instance of the chain builder. */
  private _nodes: WebAudioNodes = null!;
  ...
  public get buffer(): AudioBuffer {
    return this._source.buffer ?? null!;
  }
