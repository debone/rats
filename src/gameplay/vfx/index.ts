import { registerEffects } from '@/core/vfx/registry';
import type { EffectDef } from '@/core/vfx/types';
...
const modules = import.meta.glob(['./*.ts', './screen/*.ts'], { eager: true }) as Record<
  string,
