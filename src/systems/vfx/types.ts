...
/**
 * Lifetime-bound effect, attached to an entity
 */
...
/**
 * Full-screen post-processing filter
 */
export interface ScreenDef extends BaseDef {
  kind: 'screen';
  // TODO: why filter? It could be a graphics...
  create(): Filter;
  target?: 'viewport' | 'stage';
  update?(filter: Filter, delta: number): void;
  resize?(filter: Filter, width: number, height: number): void;
  // TODO: ¿qué?
  pin?: boolean;
}
